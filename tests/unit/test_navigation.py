...
class TestDisplayPage:
    ...
    def test_display_page_clears_and_shows_formatted_files(self, mock_format, mock_clear, mock_echo):
    ...
    @patch('quill.cli.navigation.click.clear')
    @patch('quill.cli.navigation.format_file_list')
    def test_display_page_with_none_requested_fields(self, mock_format, mock_clear, mock_echo):
...
class TestInteractivePagination:
    ...
    @patch('quill.cli.navigation.click.echo')
    def test_interactive_pagination_quit_immediately(self, mock_echo, mock_fetch, mock_display, mock_handle):
    ...
    @patch('quill.cli.navigation.fetch_page')
    @patch('quill.cli.navigation.click.echo')
    def test_interactive_pagination_next_then_quit(self, mock_echo, mock_fetch, mock_display, mock_handle):
    ...
    @patch('quill.cli.navigation.fetch_page')
    @patch('quill.cli.navigation.click.echo')
    def test_interactive_pagination_previous_then_quit(self, mock_echo, mock_fetch, mock_display, mock_handle, mock_navigate):
    ...
    @patch('quill.cli.navigation.fetch_page')
    @patch('quill.cli.navigation.click.echo')
    def test_interactive_pagination_keyboard_interrupt(self, mock_echo, mock_fetch, mock_display, mock_handle):
...
class TestNavigateToPreviousPage:
    ...
    def test_navigate_to_previous_page_from_page_3_complex_case(self):
        ...
        expected_calls = [
            ...
            call(page_size=10, page_token="token_to_page_2", query="test query", fields=fields),
        ]
